package com.juanmi.todoapi.context;
...
public class SwaggerConfig {
    ...
    public Docket api(){
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.juanmi.todoapi.controller")) //Busca dentro del paquete controller todas las clases @RestController
